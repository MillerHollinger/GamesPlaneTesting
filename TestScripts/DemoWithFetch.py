...
while run:
    ...
    if best_state in ses.fetcher.board_cache:
        print("Fetched a web image!")
        #image = overlay_image(image, ses.fetcher.board_cache[most_votes], 0, 0)
        ...
        #image = warp_and_overlay(image, ses.fetcher.board_cache[most_votes], np.array(((0, 0), (100, 0), (100, 100), (0, 100))))
        print(image.shape)
    else:
