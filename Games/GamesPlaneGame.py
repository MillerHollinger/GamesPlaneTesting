...
class GamesPlaneGame:
    def __init__(self, name: str, anchored_arucos: list[PhysicalAruco], unanchored_arucos: list[PhysicalAruco], valid_positions: list[tuple[float, float]], cm_to_space: float, camera_yaml: str):
        self.name = name
